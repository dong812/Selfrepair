...
NeuVar.CA2Store = zeros(Par.Num_Inputs_OP * Par.Num_Neurons_OP,Par.T);
NeuVar.rou = zeros(Par.Num_Inputs_OP * Par.Num_Neurons_OP,Par.T);
NeuVar.omega = zeros(Par.Num_Inputs_OP * Par.Num_Neurons_OP,Par.T);
NeuVar.omega(:,1) =300;
